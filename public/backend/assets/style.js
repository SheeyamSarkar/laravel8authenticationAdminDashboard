    ...
    axios.get('http://127.0.0.1:8000/api/items')
        .then(res => {
            if (res.status === 200 && res.data.status === true) {
                ...
                axios.get(`http://127.0.0.1:8000/api/order/${orderId}/details`)
                    .then(res => {
                        if (res.status === 200 && res.data.status === true) {
...
function addExistingItem() {
    ...
    <td>
        <button onclick="delete_row('row_combo_edit${$row_track_id1}')" id="comboDelBtn${$row_track_id1}" class="delBtn"><img src="assets/ic_baseline-delete.svg"
                alt=""></button>
    </td>
</tr>
...
function add_row_combo_edit() {
    ...
    <td>
        <button onclick="delete_row('row_combo_edit${$row_track_id}')" id="comboDelBtn${$row_track_id}" class="delBtn"><img src="assets/ic_baseline-delete.svg"
                alt=""></button>
    </td>
</tr>
...
function totalCalculator() {
    ...
    $('.vatAmount').html(`${orderItem.vat}%`);
    $('.vatAmountInput').val(orderItem.vat);
