...
<div class="row">
    ...
    {{-- <div class="col-6 text-right">
        <h1 class="section-title">1,40,010</h1>
    </div> --}}
</div>
    ...
    <div class="col-12 col-md-6 col-lg-3">
        <div class="card m-b-30 card-body dashboardCard">
            <div class="card-content">
                ...
                <div class="row">
                    <div class="col-6">
                        <p><img src="{{ asset('backend/assets/tick.svg') }}" alt="">1020</p>
                    </div>
                    <div class="col-6 text-right">
                        <p><img src="{{ asset('backend/assets/cross.svg') }}" alt="">40</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="row pt-5">
    <div class="col-12 col-md-6 col-lg-3">
        <div class="card m-b-30 card-body dashboardCard orderCard activeOrderCard">
            <div class="secondCardContent ">
                ...
                <div>
                    <h1 class="orderValue" data-order="1">1</h1>
                    <h5>New Orders</h5>
                </div>
            </div>
        </div>
    ...
    <div class="col-12 col-md-6 col-lg-3">
        <div class="card m-b-30 card-body dashboardCard">
            <div class="secondCardContent">
                <div>
                    <img src="{{ asset('backend/assets/emojione-monotone_pot-of-food.svg') }}" alt="">
                </div>
                <div>
                    <h1>12</h1>
                    <h5>Preparing</h5>
    ...
    <div class="col-12 col-md-6 col-lg-3">
        <div class="card m-b-30 card-body dashboardCard">
            <div class="secondCardContent">
                <div>
                    <img src="{{ asset('backend/assets/ic_round-delivery-dining.svg') }}" alt="">
                </div>
                <div>
                    <h1>6</h1>
                    <h5>Delivering</h5>
...
<div class="row pt-5">
    <div class="col-12 col-md-6 col-lg-3">
        <div class="card m-b-30 card-body dashboardCard">
            <div class="secondCardContent">
                <div>
                    <img src="{{ asset('backend/assets/complete.svg') }}" alt="">
                </div>
                <div>
                    <h1>101</h1>
                    <h5>Completed</h5>
    ...
    <div class="col-12 col-md-6 col-lg-3">
        <div class="card m-b-30 card-body dashboardCard">
            <div class="secondCardContent">
                <div>
                    <img src="{{ asset('backend/assets/gridicons_cross-circle.svg') }}" alt="">
                </div>
                <div>
                    <h1>11</h1>
                    <h5>Cancelled</h5>
    ...
    <div class="col-12 col-md-6 col-lg-3">
        <div class="card m-b-30 card-body dashboardCard">
            <div class="secondCardContent">
                <div>
                    <img src="{{ asset('backend/assets/wpf_coins.svg') }}" alt="">
                </div>
                <div>
                    <h1>95,000</h1>
                    <h5>Revenue</h5>
