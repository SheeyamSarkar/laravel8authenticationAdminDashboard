            ...
            <div class="card-body">
                ...
                <h3 class="text-center m-0">
                    <a href="javascript:void(0)" class="logo logo-admin"><img
                            src="{{ asset('backend/assets/images/anto-logo-black.png') }}" height="100" alt="logo"></a>
                </h3>

                <div class="p-3">

                    <h4 class="text-muted font-18 mb-3 text-center">Reset Admin Password</h4>
                    @if ($errors->any())
                        <div class=" mt-3">
                    ...
                    <form class="form-horizontal reset_password m-t-30" action="{{ route('forget.password.post') }}"
                        method="POST">
                        @csrf
