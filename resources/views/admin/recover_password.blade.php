            ...
            <div class="card-body">
                <h3 class="text-center m-0">
                    <a href="javascript:void(0)" class="logo logo-admin">
                        <img src="{{ asset('backend/assets/images/anto-logo-black.png') }}" height="100" alt="logo">
                    </a>
                </h3>
                ...
                <div class="p-3">
                    ...
                    <form class="form-horizontal m-t-30 loginForm" action="{{ route('reset.password.post') }}"
                        method="POST">@csrf
                        ...
                        <div class="form-group row m-t-20">
                            <div class="col-sm-6 text-right">
                                {{-- <button class="btn btn-success btn-block w-md waves-effect waves-light" type="submit">Reset Password</button> --}}
                            </div>

                            <div class="col-sm-6 text-right">
                                <button class="btn btn-success btn-block w-md waves-effect waves-light"
            ...
            $(".loginForm").validate({
                ...
                messages: {
                    ...
                    password: {
                        ...
                        minlength: 'Password must atleast 8 charecters long',
                    },
                }
            });
        });
